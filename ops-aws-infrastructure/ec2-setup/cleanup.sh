...
LIB_DIR="/opt/mighty-dawn/lib"

echo "=== Cleaning up old files ==="

# Clean up log files older than 30 days
echo "Cleaning log files older than 30 days..."
DELETED_LOGS=$(find "$LOG_DIR" -name "mighty-dawn-*.log" -mtime +30 -type f -print -delete 2>/dev/null | wc -l)
...
echo "Current disk usage for /opt/mighty-dawn:"
